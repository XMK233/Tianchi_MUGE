...
class ClassConditionedUViT(nn.Module):
    ...
    接口适配目标文件需求。
    """
    def __init__(self, text_emb_size=768, class_emb_size=128, vit_dim=256, vit_heads=4, vit_layers=6, num_experts=10, time_emb_size=32):
        super().__init__()
        # 条件嵌入
        ...
        # 门控网络：仅基于文本嵌入与时间步嵌入进行路由
        gate_in_dim = class_emb_size + time_emb_size
    ...
    def forward(self, x, t, text_emb):
        ...
        gate_in = torch.cat([c_feat, t_feat], dim=1)
